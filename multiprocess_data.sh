...
set -e
# Set these for you:
OUT_DIR=processed_dataset_ddd20_paper/day
...
# ------------------ ANN on APS -------------- #
ipython ./multitrain_test_cnn_pytorch.py -- --h5files ${frames_h5list[@]} --dataset_keys ${frames_type_list[@]} --run_id ann_only_aps --optimizer "Adam" --lr 0.001 --batch_size 64

# ------------------ ANN on accumulated DVS -----------#
ipython ./multitrain_test_cnn_pytorch.py -- --h5files ${dvs_accum_frames_h5list[@]} --dataset_keys ${dvs_accum_frames_type_list[@]} --run_id ann_only_acc_dvs --optimizer "Adam" --lr 0.001 --batch_size 64

# ------------------ ANN on APS + Accumulated DVS ---------- #
ipython ./multitrain_test_cnn_pytorch.py -- --h5files ${frames_h5list[@]} ${dvs_accum_frames_h5list[@]} --dataset_keys ${frames_type_list[@]} ${dvs_accum_frames_type_list[@]} --run_id ann_combined_aps_and_acc_dvs --optimizer "Adam" --lr 0.001 --batch_size 64
...
# ------------------ SNN on APS -------------- #
# ipython ./multitrain_test_cnn_pytorch.py -- --h5files ${frames_h5list[@]} --dataset_keys ${frames_type_list[@]} --run_id aps_snn --snn --BNTT --timesteps 20 --optimizer "Adam"

# ------------------ SNN on timestep split DVS ------------#
# ipython ./multitrain_test_cnn_pytorch.py -- --h5files ${dvs100ms_h5list[@]} --dataset_keys ${dvs100ms_type_list[@]} --run_id dvs_snn_timesteps --dvs --snn --BNTT --split_timesteps --seperate_dvs_channels --timesteps 20 --optimizer "Adam"

# ------------------ SNN on rate coded DVS --------------- #
# ipython ./multitrain_test_cnn_pytorch.py -- --h5files ${dvs_accum_frames_h5list[@]} --dataset_keys ${dvs_accum_frames_type_list[@]} --run_id dvs_snn_first_conv_coded --timesteps 20 --snn --BNTT --optimizer "Adam"
